          ...
          <div className="bg-gradient-to-br from-blue-500 via-blue-500 to-cyan-400 text-white rounded-[2.5rem] p-8 lg:p-9 font-bold text-justify shadow-[0_6px_32px_rgba(59,130,246,0.25)] max-w-[820px] w-full lg:ml-28 overflow-wrap-break-word word-break-break-word order-2 lg:order-1">
            <div>
              <div className="text-center">
                <span className="text-white bg-blue-800 rounded-lg px-2 py-1 mr-2 text-[1.3rem]">
                  INSTRUCTIONS
                </span>
              </div>
              <br /><br />
              ...
              <br /><br />
              <div className="text-cyan-100">Good luck — you're going to do <span className="font-bold text-white">great</span>! 🚀</div>
              <br />
              <div className="text-white">
                If you don't pass, you can always go back, review the lesson and activities,<br /> and <span className="font-bold text-green-300"> try again</span>.
              </div>
            </div>
          </div>
          <img 
