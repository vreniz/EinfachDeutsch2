    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center min-h-[450px]">
          <div className="w-[95vw] sm:w-[570px] max-w-[98vw] min-h-[360px] bg-violet-200 rounded-[2.2rem] mb-9 mt-5 shadow-[0_4px_30px_rgba(167,139,250,0.47)] text-violet-800 p-6 sm:p-10 pt-8 flex flex-col items-center transition-all duration-300 break-words">
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center min-h-[450px]">
        ...
        <div
          className={`w-[95vw] sm:w-[570px] max-w-[98vw] min-h-[360px] bg-violet-400 rounded-[2.2rem] mb-9 mt-5 shadow-[0_4px_30px_rgba(167,139,250,0.47)] text-white p-6 sm:p-10 pt-8 flex flex-col items-center transition-all duration-300 break-words ${
            animDirection === 'right' 
